...
model_district = pystan.StanModel(file = SCRIPTS_PATH + 'model_gln_district.stan')
...
model = pystan.StanModel(file = SCRIPTS_PATH + 'model_gln_pool.stan')
# 5. Run model
ut.get_posteriors_pooling(all_dfs, columns, model, 'gln', params, district_posteriors, n_strats, strat_name)
